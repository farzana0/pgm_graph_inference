...
then
    ...
    python create_data.py --data_mode train --mode marginal --algo $label_algo \
                          --verbose True --unlab_graphs_path fc_train  # used to be: nontrees_train (all at once)

elif [ $1 == 'train' ]
then
    echo -e "\tTraining your GNN"
    python train.py --train_set_name fc_approx --mode marginal --epochs 5 --verbose True

elif [ $1 == 'test' ]
then
    echo -e "\tRunning tests"
    python ./experiments/run_exps.py --exp_name fc_approx
